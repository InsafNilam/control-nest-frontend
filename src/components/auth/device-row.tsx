...
export const DeviceRow = ({ value }: { value: IDevice }) => {
    ...
    <tr key={value.id}>
        ...
        <div className="flex items-center gap-x-2">
          <img
            ...
            src={
              value.image?.url
                ? value.image?.url
                : "https://www.shutterstock.com/image-vector/devices-icon-260nw-556088086.jpg"
            }
            alt=""
          />
          <div>
      ...
      <td className="px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
        ...
        >
          ...
          <h2 className="text-sm font-normal">{value.status}</h2>
        </div>
      </td>
      <td className="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">
        <div className="flex items-center gap-x-2">
          ...
          <Dialog open={deleteOpen} onOpenChange={setDeleteOpen}>
            ...
            <DialogContent className="sm:max-w-[512px] rounded-md">
              <DialogHeader>
                ...
                <DialogDescription>
                  Delete Devices from your profile here. Click yes when
                  you&apos;re done.
                </DialogDescription>
              </DialogHeader>
              {/* Note Form to ADD */}
